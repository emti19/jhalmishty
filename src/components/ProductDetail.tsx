    ...
    return (
      <main className="min-h-screen bg-[#FAF7F2] pt-24">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <div className="rounded-3xl border border-[#A8C686]/20 bg-white p-6 sm:p-12 shadow-sm">
  ...
  return (
    <main className="min-h-screen bg-[#FAF7F2] pt-24">
      <div className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid items-start gap-6 sm:gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-6">
              ...
              <div className="flex gap-3">
                {images.map((image, index) => (
                  <button
                    ...
                    className={`relative h-16 w-16 sm:h-20 sm:w-20 overflow-hidden rounded-2xl border-2 transition-all ${
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
              <div className="rounded-3xl border border-[#A8C686]/15 bg-white p-3 sm:p-5 text-xs sm:text-sm">
                <p className="mb-1 sm:mb-2 text-[#4a6b5f]">Category</p>
                <p className="font-semibold capitalize text-[#1A2E28]">
                  {product.category}
                </p>
              </div>
              <div className="rounded-3xl border border-[#A8C686]/15 bg-white p-3 sm:p-5 text-xs sm:text-sm">
                <p className="mb-1 sm:mb-2 text-[#4a6b5f]">Unit</p>
                <p className="font-semibold text-[#1A2E28]">{product.unit}</p>
              </div>
              <div className="rounded-3xl border border-[#A8C686]/15 bg-white p-3 sm:p-5 text-xs sm:text-sm">
                <p className="mb-1 sm:mb-2 text-[#4a6b5f]">Rating</p>
                <p className="font-semibold text-[#1A2E28]">
                  {product.rating} / 5
                </p>
              </div>
              <div className="rounded-3xl border border-[#A8C686]/15 bg-white p-3 sm:p-5 text-xs sm:text-sm">
                <p className="mb-1 sm:mb-2 text-[#4a6b5f]">Reviews</p>
                <p className="font-semibold text-[#1A2E28]">{product.reviews}</p>
              </div>
            </div>
          </div>

          <div className="space-y-5 sm:space-y-8 rounded-[2rem] border border-[#A8C686]/15 bg-white p-4 sm:p-6 lg:p-8 shadow-sm">
            <div>
              <h1 className="mb-3 text-2xl sm:text-3xl lg:text-4xl font-bold text-[#1A2E28]">
                {product.name}
              </h1>
            ...
            <div className="rounded-[1.5rem] border border-[#A8C686]/15 bg-[#FAF7F2] p-4 sm:p-6">
              <div className="flex items-end justify-between gap-4">
                <div>
                  <p className="text-sm text-[#4a6b5f]">Price</p>
                  <p className="text-2xl sm:text-4xl font-bold text-[#2F5D50]">
